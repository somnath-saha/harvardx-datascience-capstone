...
## About the dataset
The dataset - **House Sales in King County, USA: Predict house price using regression** is taken from Kaggle. Kaggle, a subsidiary of Google LLC, is an online community of data scientists and machine learning practitioners. Kaggle allows users to find and publish data sets, explore and build models in a web-based data-science environment, work with other data scientists and machine learning engineers, and enter competitions to solve data science challenges. It contains price data of **21613** houses wherin every house has **21** features. \
**Go to kaggle page**: *<https://www.kaggle.com/harlfoxem/housesalesprediction>* 

## Goal of the project
The goal of the project is study the dataset and develop a model that can predict house prices with reasonable accuracy.

## Key steps to reach the final model
The initial parts of the project will help to gain insights into the data through tabular and visual means. This is done in R language and use the publicly available powerful *R* libraries like ggplot. Next, models are trained with the different alogrithms and the model with the best RMSE is chosen to validate against the final validation set.
